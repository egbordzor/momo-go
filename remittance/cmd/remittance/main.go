...
import (
	...
	remittance "github.com/wondenge/momo-go/remittance"
...
func main() {
	...
	{
		tokenSvc = remittance.NewToken(logger)
		validateSvc = remittance.NewValidate(logger)
		getbalanceSvc = remittance.NewGetbalance(logger)
		transferSvc = remittance.NewTransfer(logger)
	}
