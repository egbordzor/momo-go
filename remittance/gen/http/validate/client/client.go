...
//
// validate client HTTP transport
//
// Command:
...
// Client lists the validate service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the validate service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Show returns an endpoint that makes HTTP requests to the validate service
// show server.
func (c *Client) Show() endpoint.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("validate", "show", err)
		}
