...
//
// transfer HTTP server encoders and decoders
//
// Command:
...
func EncodeCreateResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*transferviews.Errorreason)
		enc := encoder(ctx, w)
...
// DecodeCreateRequest returns a decoder for requests sent to the transfer
// create endpoint.
...
// EncodeGetResponse returns an encoder for responses returned by the transfer
// get endpoint.
...
// DecodeGetRequest returns a decoder for requests sent to the transfer get
// endpoint.
...
// EncodeGetError returns an encoder for errors returned by the get transfer
// endpoint.
