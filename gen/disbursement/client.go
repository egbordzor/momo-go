...
// Client is the "Disbursement" service client.
type Client struct {
...
// NewClient initializes a "Disbursement" service client given the endpoints.
...
// NewToken calls the "NewToken" endpoint of the "Disbursement" service.
...
// GetBalance calls the "GetBalance" endpoint of the "Disbursement" service.
...
// Transfer calls the "Transfer" endpoint of the "Disbursement" service.
// Transfer may return the following errors:
//	- "bad_request" (type *goa.ServiceError): Bad request, e.g. invalid data was sent in the request.
//	- "conflict" (type *goa.ServiceError): Conflict, duplicated reference id
//	- "internal_error" (type *ErrorReason): Internal error.
//	- error: internal error
...
// TransferStatus calls the "TransferStatus" endpoint of the "Disbursement"
// service.
