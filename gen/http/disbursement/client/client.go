...
//
// Disbursement client HTTP transport
//
// Command:
...
// Client lists the Disbursement service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the Disbursement service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// NewToken returns an endpoint that makes HTTP requests to the Disbursement
...
func (c *Client) NewToken() endpoint.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Disbursement", "NewToken", err)
		}
		return decodeResponse(resp)
	}
}

// GetBalance returns an endpoint that makes HTTP requests to the Disbursement
...
func (c *Client) GetBalance() endpoint.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Disbursement", "GetBalance", err)
		}
		return decodeResponse(resp)
	}
}
...
// Disbursement service RetrieveAccountHolder server.
func (c *Client) RetrieveAccountHolder() endpoint.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Disbursement", "RetrieveAccountHolder", err)
		}
		return decodeResponse(resp)
	}
}

// Transfer returns an endpoint that makes HTTP requests to the Disbursement
...
func (c *Client) Transfer() endpoint.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Disbursement", "Transfer", err)
		}
		return decodeResponse(resp)
	}
}
...
// Disbursement service TransferStatus server.
func (c *Client) TransferStatus() endpoint.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Disbursement", "TransferStatus", err)
		}
		return decodeResponse(resp)
	}
}
