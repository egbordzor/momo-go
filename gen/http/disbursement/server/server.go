...
// Server lists the Disbursement service endpoint HTTP handlers.
type Server struct {
	Mounts                []*MountPoint
...
// New instantiates HTTP handlers for all the Disbursement service endpoints
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"NewToken", "POST", "/disbursement/token"},
			{"GetBalance", "GET", "/disbursement/v1_0/account/balance"},
			{"RetrieveAccountHolder", "GET", "/disbursement/v1_0/accountholder/{accountHolderIdType}/{accountHolderId}/active"},
			{"Transfer", "POST", "/disbursement/v1_0/transfer"},
			{"TransferStatus", "GET", "/disbursement/v1_0/transfer/{referenceId}"},
		},
...
func (s *Server) Service() string { return "Disbursement" }
...
// Mount configures the mux to serve the Disbursement endpoints.
...
// MountNewTokenHandler configures the mux to serve the "Disbursement" service
// "NewToken" endpoint.
...
// calls the "Disbursement" service "NewToken" endpoint.
func NewNewTokenHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "Disbursement")
...
// MountGetBalanceHandler configures the mux to serve the "Disbursement"
// service "GetBalance" endpoint.
...
// calls the "Disbursement" service "GetBalance" endpoint.
...
// "Disbursement" service "RetrieveAccountHolder" endpoint.
func MountRetrieveAccountHolderHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/disbursement/v1_0/accountholder/{accountHolderIdType}/{accountHolderId}/active", f)
}

// NewRetrieveAccountHolderHandler creates a HTTP handler which loads the HTTP
// request and calls the "Disbursement" service "RetrieveAccountHolder"
// endpoint.
...
// MountTransferHandler configures the mux to serve the "Disbursement" service
// "Transfer" endpoint.
...
// calls the "Disbursement" service "Transfer" endpoint.
...
// MountTransferStatusHandler configures the mux to serve the "Disbursement"
...
// and calls the "Disbursement" service "TransferStatus" endpoint.
