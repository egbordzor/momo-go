...
//
// Disbursement HTTP server types
//
// Command:
...
// "NewToken" endpoint of the "Disbursement" service.
func NewNewTokenResponseBody(res *disbursementviews.TokenPost200ApplicationJSONResponseView) *NewTokenResponseBody {
...
// the "GetBalance" endpoint of the "Disbursement" service.
func NewGetBalanceResponseBody(res *disbursementviews.BalanceView) *GetBalanceResponseBody {
...
// of the "TransferStatus" endpoint of the "Disbursement" service.
func NewTransferStatusResponseBody(res *disbursementviews.TransferResultView) *TransferStatusResponseBody {
	...
	if res.Payee != nil {
		body.Payee = marshalDisbursementviewsPartyViewToPartyResponseBody(res.Payee)
	}
	if res.Reason != nil {
		body.Reason = marshalDisbursementviewsErrorReasonViewToErrorReasonResponseBody(res.Reason)
	}
	return body
}

// NewNewTokenUnauthorizedResponseBody builds the HTTP response body from the
// result of the "NewToken" endpoint of the "Disbursement" service.
func NewNewTokenUnauthorizedResponseBody(res *disbursement.TokenPost401ApplicationJSONResponse) *NewTokenUnauthorizedResponseBody {
...
// result of the "GetBalance" endpoint of the "Disbursement" service.
...
// the result of the "GetBalance" endpoint of the "Disbursement" service.
...
// from the result of the "RetrieveAccountHolder" endpoint of the
...
// result of the "Transfer" endpoint of the "Disbursement" service.
func NewTransferInternalErrorResponseBody(res *disbursement.ErrorReason) *TransferInternalErrorResponseBody {
...
// the result of the "TransferStatus" endpoint of the "Disbursement" service.
...
// result of the "TransferStatus" endpoint of the "Disbursement" service.
...
// from the result of the "TransferStatus" endpoint of the "Disbursement"
// service.
...
// NewRetrieveAccountHolderPayload builds a Disbursement service
// RetrieveAccountHolder endpoint payload.
func NewRetrieveAccountHolderPayload(accountHolderIDType string, accountHolderID string) *disbursement.RetrieveAccountHolderPayload {
...
// NewTransfer1 builds a Disbursement service Transfer endpoint payload.
func NewTransfer1(body *TransferRequestBody) *disbursement.Transfer1 {
	...
	if body.Payee != nil {
		v.Payee = unmarshalPartyRequestBodyToDisbursementParty(body.Payee)
	}

	return v
}

// NewTransferStatusPayload builds a Disbursement service TransferStatus
// endpoint payload.
func NewTransferStatusPayload(referenceID string) *disbursement.TransferStatusPayload {
