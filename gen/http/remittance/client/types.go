...
// "Transfer" endpoint of the "remittance" service.
func NewTransferRequestBody(p *remittance.Transfer1) *TransferRequestBody {
	...
	if p.Payee != nil {
		body.Payee = marshalRemittancePartyToPartyRequestBody(p.Payee)
	}
	return body
}

// NewNewTokenTokenPost200ApplicationJSONResponseOK builds a "remittance"
// service "NewToken" endpoint result from a HTTP "OK" response.
func NewNewTokenTokenPost200ApplicationJSONResponseOK(body *NewTokenResponseBody) *remittanceviews.TokenPost200ApplicationJSONResponseView {
	v := &remittanceviews.TokenPost200ApplicationJSONResponseView{
...
// NewNewTokenInternalError builds a remittance service NewToken endpoint
// internal_error error.
...
// NewNewTokenUnauthorized builds a remittance service NewToken endpoint
// unauthorized error.
func NewNewTokenUnauthorized(body *NewTokenUnauthorizedResponseBody) *remittance.TokenPost401ApplicationJSONResponse {
	v := &remittance.TokenPost401ApplicationJSONResponse{
...
// NewGetBalanceBalanceOK builds a "remittance" service "GetBalance" endpoint
// result from a HTTP "OK" response.
func NewGetBalanceBalanceOK(body *GetBalanceResponseBody) *remittanceviews.BalanceView {
	v := &remittanceviews.BalanceView{
...
// NewGetBalanceBadRequest builds a remittance service GetBalance endpoint
// bad_request error.
...
// NewGetBalanceInternalError builds a remittance service GetBalance endpoint
// internal_error error.
...
// NewRetrieveAccountHolderBadRequest builds a remittance service
...
// NewRetrieveAccountHolderInternalError builds a remittance service
...
// NewTransferBadRequest builds a remittance service Transfer endpoint
// bad_request error.
...
// NewTransferConflict builds a remittance service Transfer endpoint conflict
// error.
...
// NewTransferInternalError builds a remittance service Transfer endpoint
// internal_error error.
...
// NewTransferStatusTransferResultOK builds a "remittance" service
// "TransferStatus" endpoint result from a HTTP "OK" response.
func NewTransferStatusTransferResultOK(body *TransferStatusResponseBody) *remittanceviews.TransferResultView {
	v := &remittanceviews.TransferResultView{
		Amount:                 body.Amount,
		Currency:               body.Currency,
	...
	if body.Payee != nil {
		v.Payee = unmarshalPartyResponseBodyToRemittanceviewsPartyView(body.Payee)
	}
	if body.Reason != nil {
		v.Reason = unmarshalErrorReasonResponseBodyToRemittanceviewsErrorReasonView(body.Reason)
	}

	return v
}

// NewTransferStatusBadRequest builds a remittance service TransferStatus
...
// NewTransferStatusNotFound builds a remittance service TransferStatus
...
// NewTransferStatusInternalError builds a remittance service TransferStatus
