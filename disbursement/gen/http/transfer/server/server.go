...
// Server lists the transfer service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Create http.Handler
	Get    http.Handler
...
// New instantiates HTTP handlers for all the transfer service endpoints using
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Create", "POST", "/disbursement/v1_0/transfer"},
			{"Get", "GET", "/disbursement/v1_0/transfer/{referenceId}"},
		},
...
func (s *Server) Service() string { return "transfer" }
...
// Mount configures the mux to serve the transfer endpoints.
...
// calls the "transfer" service "create" endpoint.
func NewCreateHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "transfer")
...
// the "transfer" service "get" endpoint.
func NewGetHandler(
	endpoint endpoint.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
