...
// Server lists the getbalance service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Show   http.Handler
}
...
// New instantiates HTTP handlers for all the getbalance service endpoints
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Show", "GET", "/disbursement/v1_0/account/balance"},
		},
...
func (s *Server) Service() string { return "getbalance" }
...
// Mount configures the mux to serve the getbalance endpoints.
...
// the "getbalance" service "show" endpoint.
func NewShowHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "getbalance")
