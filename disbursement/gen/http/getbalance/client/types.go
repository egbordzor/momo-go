...
// NewShowErrorreasonOK builds a "getbalance" service "show" endpoint result
// from a HTTP "OK" response.
func NewShowErrorreasonOK(body *ShowResponseBody) *getbalanceviews.ErrorreasonView {
	v := &getbalanceviews.ErrorreasonView{
		Code:    body.Code,
...
// NewShowBadRequest builds a getbalance service show endpoint bad_request
// error.
