...
import (
	...
	"github.com/wondenge/momo-go/disbursement/gen/http/validate/server"
	goahttp "goa.design/goa/v3/http"
)

// EncodeShowResponse returns a go-kit EncodeResponseFunc suitable for encoding
// validate show responses.
...
// errors returned by the validate show endpoint.
