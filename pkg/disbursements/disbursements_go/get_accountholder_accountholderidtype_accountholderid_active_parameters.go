...
type GetAccountholderAccountholderidtypeAccountholderidActiveParams struct {
	...
	*/
	...
	/*AccountHolderID
	  The party number. Validated according to the party id type. <br> MSISDN - Mobile Number validated according to ITU-T E.164. Validated with IsMSISDN<br> EMAIL - Validated to be a valid e-mail format. Validated with IsEmail<br> PARTY_CODE - UUID of the party. Validated with IsUuid
