...
// MoMoRemittance DefaultApi service
type MoMoRemittance service
...
@return Balance
*/
func (a *MoMoRemittance) GetAccountBalance(ctx _context.Context, xTargetEnvironment string, opts *GetAccountBalanceOpts) (Balance, *_nethttp.Response, error) {
	var (
 ...
 * @param "Authorization" (optional.String) -  Authorization header used for Basic authentication and oauth. Format of the header parameter follows the standard for Basic and Bearer. Oauth uses Bearer authentication type where the credential is the received access token.
*/
func (a *MoMoRemittance) GetAccountholderAccountholderidtypeAccountholderidActive(ctx _context.Context, accountHolderId string, accountHolderIdType string, xTargetEnvironment string, opts *GetAccountholderAccountholderidtypeAccountholderidActiveOpts) (*_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
...
*/
func (a *MoMoRemittance) TokenPOST(ctx _context.Context, authorization string) (TokenPost200ApplicationJsonResponse, *_nethttp.Response, error) {
	var (
...
*/
func (a *MoMoRemittance) TransferPOST(ctx _context.Context, xReferenceId string, xTargetEnvironment string, opts *TransferPOSTOpts) (*_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodPost
		postBody     interface{}
		formFileName string
...
*/
func (a *MoMoRemittance) TransferReferenceIdGET(ctx _context.Context, referenceId string, xTargetEnvironment string, opts *TransferReferenceIdGETOpts) (TransferResult, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
